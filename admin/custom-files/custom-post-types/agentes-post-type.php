 ...
 */
 ...
 if (!function_exists('agente_post_type')){
	 function agente_post_type() {
	 
		 $labels = array(
			 'name'                  => _x( 'Agentes', 'Post Type General Name', 'compara_inmuebles_plugin' ),
			 'singular_name'         => _x( 'agente', 'Post Type Singular Name', 'compara_inmuebles_plugin' ),
			 'menu_name'             => __( 'Agentes', 'compara_inmuebles_plugin' ),
			 'name_admin_bar'        => __( 'Agentes', 'compara_inmuebles_plugin' ),
			 ...
			 'all_items'             => __( 'Todos los agentes', 'compara_inmuebles_plugin' ),
			 'add_new_item'          => __( 'Agregar nuevo agente', 'compara_inmuebles_plugin' ),
			 'add_new'               => __( 'Agregar agente', 'compara_inmuebles_plugin' ),
			 'new_item'              => __( 'Nuevo agente', 'compara_inmuebles_plugin' ),
			 'edit_item'             => __( 'Editar agente', 'compara_inmuebles_plugin' ),
			 'update_item'           => __( 'Actualizar agente', 'compara_inmuebles_plugin' ),
			 'view_item'             => __( 'Ver agente', 'compara_inmuebles_plugin' ),
			 'view_items'            => __( 'Ver agentes', 'compara_inmuebles_plugin' ),
			 'search_items'          => __( 'Buscar agente', 'compara_inmuebles_plugin' ),
		 ...
		 $args = array(
			 'label'                 => __( 'Agente', 'compara_inmuebles_plugin' ),
			 'description'           => __( 'Post type de los agentes inmobiliarios', 'compara_inmuebles_plugin' ),
			 'labels'                => $labels,
	 ...
	 add_action( 'init', 'agente_post_type', 0 );
 }